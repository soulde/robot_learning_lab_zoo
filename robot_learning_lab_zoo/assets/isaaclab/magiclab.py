...
MAGICLAB_BOT_GEN1_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{ROBOTS_DIR}/magiclab/magicbot-Gen1/urdf/MAGICBOT.urdf",
...
MAGICLAB_BOT_Z1_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=False,
        replace_cylinders_with_capsules=False,
        asset_path=f"{ROBOTS_DIR}/magiclab/magicbot-Z1/urdf/MagicBotZ1.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
...
MAGICDOG_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        merge_fixed_joints=False,
        replace_cylinders_with_capsules=False,
        asset_path=f"{ROBOTS_DIR}/magiclab/magicdog/urdf/magicdog.urdf",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
