...
FFTAI_GR1T1_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{ROBOTS_DIR}/fftai/gr1t1_description/urdf/GR1T1.urdf",
...
FFTAI_GR1T1_LOWER_LIMB_CFG.spawn.asset_path = (
    f"{ROBOTS_DIR}/fftai/gr1t1_description/urdf/GR1T1_lower_limb.urdf"
)
...
FFTAI_GR1T2_CFG.spawn.asset_path = f"{ROBOTS_DIR}/fftai/gr1t2_description/urdf/GR1T2.urdf"
"""Configuration for the FFTAI GR1T1 Humanoid robot."""


FFTAI_GR1T2_LOWER_LIMB_CFG = FFTAI_GR1T1_LOWER_LIMB_CFG.copy()
FFTAI_GR1T2_LOWER_LIMB_CFG.spawn.asset_path = (
    f"{ROBOTS_DIR}/fftai/gr1t2_description/urdf/GR1T2_lower_limb.urdf"
)
