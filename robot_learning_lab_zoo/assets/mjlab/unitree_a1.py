...
UNITREE_A1_XML: Path = ROBOTS_DIR / "unitree" / "a1_description" / "xmls" / "a1.xml"
...
UNITREE_A1_FOOT_GEOM_NAMES = tuple(f"{site}_collision" for site in UNITREE_A1_FOOT_SITE_NAMES)
...
def _name_collision_geoms(spec: mujoco.MjSpec) -> None:
    ...
    for body_name, site_name in zip(UNITREE_A1_FOOT_BODY_NAMES, UNITREE_A1_FOOT_SITE_NAMES, strict=True):
